...
import Portrait from './Portfolio/Portrait.jpg'
import './App.css'
import {  JSX  } from 'react'
import React from 'react'

function LeftColumn(props: {imageSrc: string, description: () => JSX.Element}) : JSX.Element
{
  return (
    <div className="flex-container">
    <div className="columnImage">
      <div>
        <img src= {props.imageSrc} width="100%" height="50%" />
      </div>
    </div>
...
function LeftColumn2(props: {imageSrc: string, children: JSX.Element}) : JSX.Element
{
  return (
    <div className="flex-container">
    <div className="columnImage">
...
class LeftComponent extends React.Component<ILeft, {}> {
  render() : JSX.Element {
...
function App() : JSX.Element {
  ...
  const testDesc = () : JSX.Element => (<><h1>About Me</h1>
    <p>
  ...
  return (
    <>
      <LeftColumn imageSrc= {Portrait} description = {testDesc}>
      </LeftColumn>
      <LeftColumn2 imageSrc= {Portrait}>
        { testDesc() }
      </LeftColumn2>
      
      <LeftComponent imageSrc= {Portrait}>
        { testDesc()}
      </LeftComponent>
  <div className="flex-container">
    <div className="columnImage">
      <div>
        <img src= {Portrait} width="100%" height="50%" />
      </div>
    </div>
    <div className="columnText">
      <h1>About Me</h1>
  ...
  <div className="flex-container">
    <div className="columnImage">
      <img src="Portfolio/OnMyWayHome.gif" width="100%" />
    </div>
    <div className="columnText">
      <h1>On My Way Home</h1>
      <p>
  ...
  <div className="flex-container">
    ...
    <div className="columnImage">
      <img src="Portfolio/Mechroneer.gif" width="100%" />
    </div>
  </div>
  <div className="flex-container">
    <div className="columnImage">
      <img src="Portfolio/WordMeetsTee.gif" width="55%" />
    </div>
    <div className="columnText">
      <h2>WordMeetsTee</h2>
      <p>
  ...
  <div className="flex-container">
    ...
    <div className="columnImage">
      <img src="Portfolio/ChessSoccer.gif" width="100%" />
    </div>
  </div>
    </>
  )
